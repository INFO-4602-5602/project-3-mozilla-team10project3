...
Launch a http server from our project directory, navigate to the respective visualzation files (vis1.html, vis2.html), open and it should work.
...
We built the visualization using D3 and CSV files processed in Python. We used [colorbrewer.com](http://colorbrewer2.org/#type=sequential&scheme=BuGn&n=3) to determine the color palet. In building the visualization we ran into typical bugs such as handling asynochronous function calls correctly and managing multidimensional dictionaries.
...
#### How to view
Hover over and click individual lines to display sub-regional data. Click the refresh in browser to return to region breakdown. 
...
One design challenge was quality zoom and how the projection hindered some clarity in seeing individual countries, typically small areas such as Israel or some European countries. We chose the mercator projection as it showed the most countries at the farthest level of zoom.
...
Stephen - D3 programming, visualization 1 design, data filtering support

William - Visualization 2 designer, D3 and Python programming

Yoshinari - Visualization 1 designer, data filtering in Python, D3 programming support
